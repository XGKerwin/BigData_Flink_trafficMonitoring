...
object CarTrackInfoAnalysis1 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val stream1: DataStream[TrackInfo] = streamEnv.readTextFile("C:\\Users\\AIY\\IdeaProjects\\BigData_Flink_trafficMonitoring\\src\\main\\resources\\log_2022-07-21_0.log")
      .map(line => {
        var arr = line.split(",")
    ...
    //开窗
    val value = stream1.countWindowAll(10) //全局的count窗口
      .apply(
        (win: GlobalWindow, input: Iterable[TrackInfo], out: Collector[util.List[Put]]) => {
